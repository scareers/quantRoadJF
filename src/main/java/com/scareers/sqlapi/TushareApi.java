...
public class TushareApi {
    ...
    public static Cache<String, List<String>> keyIntsDateByStockAndTodayCache = CacheUtil.newLRUCache(32768);
    public static Cache<String, Double> closePriceOfQfqStockSpecialDayCache = CacheUtil.newLRUCache(32768);
    public static Cache<String, DataFrame<Object>> stockPriceOneDayCache = CacheUtil.newLRUCache(32768);
