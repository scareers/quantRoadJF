...
public class TushareFSApi {
    ...
    public static Cache<String, DataFrame<Object>> stockPriceFsOneDayCache = CacheUtil.newLRUCache(2048);
    public static Cache<String, DataFrame<Object>> stockPriceFsDateRangeCache = CacheUtil.newLRUCache(2048);
