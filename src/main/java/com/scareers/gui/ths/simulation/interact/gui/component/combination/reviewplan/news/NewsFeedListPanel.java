...
/**
 * description: 公司利好消息列表, 展示tab. 左编辑, 右上按钮组, 右下表格
 *
 * @author: admin
 * @date: 2022/3/17/017-00:11:16
 */
@Getter
public abstract class NewsFeedListPanel extends DisplayPanel {
    protected NewsFeedEditorPanel editorPanel; // 编辑面
    protected NewsFeed currentBean;
    ...
    public NewsFeedListPanel(NewsTabPanel parentS) {
        ...
        editorPanel = new NewsFeedEditorPanel(this);
    ...
    protected ConcurrentHashMap<Long, NewsFeed> beanMap;
