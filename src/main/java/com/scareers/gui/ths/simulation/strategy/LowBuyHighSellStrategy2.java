...
public class LowBuyHighSellStrategy2 extends Strategy {
    ...
    public static LowBuyHighSellStrategy2 getInstance(Trader trader, String strategyName,
        ...
        if (INSTANCE == null) {
            INSTANCE = new LowBuyHighSellStrategy2(trader, strategyName, forceManualExcludeStocks,
    ...
    public LowBuyHighSellStrategy2(Trader trader, String strategyName,
                                   List<String> forceManualExcludeStocks, // 需要设置手动排除的股票.
                                   int suitableSelectStockCount, // 期望的选股结果数量
                                   boolean preferenceMoreStock, // 更喜欢更多的股票选择结果
