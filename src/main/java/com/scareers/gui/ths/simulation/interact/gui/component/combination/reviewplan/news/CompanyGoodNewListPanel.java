 ...
 */
@Getter
public abstract class CompanyGoodNewListPanel extends DisplayPanel {
    ...
    public CompanyGoodNewListPanel(NewsTabPanel parentS) {
        ...
        CompanyGoodNewListPanel majorIssueListPanel = this;
    ...
    protected ConcurrentHashMap<Long, CompanyGoodNew> beanMap;
