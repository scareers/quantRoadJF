 ...
 */
@Getter
public abstract class FourPaperNewListPanel extends DisplayPanel {
    protected FourPaperNewEditorPanel editorPanel; // 编辑面
    protected FourPaperNew currentBean;
    ...
    public FourPaperNewListPanel(NewsTabPanel parentS) {
        ...
        FourPaperNewListPanel majorIssueListPanel = this;
        ...
        editorPanel = new FourPaperNewEditorPanel(this);
    ...
    protected ConcurrentHashMap<Long, FourPaperNew> beanMap;
            ...
            jTable.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    if (e.getClickCount() == 2) {
                        if (currentBean.getUrl().length() > 5) { // 少数情况下, url为空, 不做操作
            ...
            jTable.addKeyListener(new KeyAdapter() {
                ...
                public void keyPressed(KeyEvent e) {
                    if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                        ...
                        editorPanel.update(currentBean);
                        if (currentBean.getUrl().length() > 5) {
                            CommonUtil.openUrlWithDefaultBrowser(currentBean.getUrl());
                        }
                    }
                }
