...
public class EmPcNewsNotify {
    ...
    public static CopyOnWriteArrayList<EmPcNewItem> foundNews = new CopyOnWriteArrayList<>(); // 本程序发现的新闻列表
    ...
    public static CopyOnWriteArrayList<EmPcFastNew> foundFastNews = new CopyOnWriteArrayList<>(); // 本程序发现的新闻列表 -- 快讯
    ...
    public static CopyOnWriteArrayList<EmPcNewestHotNew> foundHotNews = new CopyOnWriteArrayList<>(); // 本程序发现的新闻列表 -- 快讯
