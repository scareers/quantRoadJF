...
/**
 * 复制的 CandlestickRenderer 源代码, 添加了 fillUp和fillDown两个属性, 控制k线的单条矩形区域是否填充颜色!
 */
public class CandlestickRendererS extends AbstractXYItemRenderer
     ...
     */
    public CandlestickRendererS() {
        this(-1.0);
    }

    // @key: 新增属性, 是否填充矩形中间!
    private transient boolean fillUp = true;
    private transient boolean fillDown = true;

    public CandlestickRendererS(boolean fillUp, boolean fillDown) {
        this(-1.0);
        this.fillUp = fillUp;
     ...
     */
    public CandlestickRendererS(double candleWidth) {
     ...
     *                         none.
     */
    public CandlestickRendererS(double candleWidth, boolean drawVolume,
...
//        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CandlestickRendererS)) {
            return false;
        }
        CandlestickRendererS that = (CandlestickRendererS) obj;
