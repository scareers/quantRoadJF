...
public class CrossLineListenerForKLineXYPlot implements ChartMouseListener {
    ...
    /*
        public static final int gapOfTwoPlotOfKline = 5; // 分时价格和成交量,两个图的gap
    ...
    public void chartMouseMoved(ChartMouseEvent event) {
        ...
        double perWeight = (totalHeight - gapOfTwoPlotOfKLine) / (weight1OfTwoPlotOfKLine + weight2OfTwoPlotOfKLine);
        // 百分比1: 从下到上的百分比, 计算 成交量图 的 上边线 的 百分比临界
        double percentOfVolPlotTop = (perWeight * weight2OfTwoPlotOfKLine) / totalHeight;
        // 百分比2: 从下到上的百分比, 计算 gap 的 上边线 的 百分比临界
        double percentOfGapTop = (perWeight * weight2OfTwoPlotOfKLine + gapOfTwoPlotOfKLine) / totalHeight;
