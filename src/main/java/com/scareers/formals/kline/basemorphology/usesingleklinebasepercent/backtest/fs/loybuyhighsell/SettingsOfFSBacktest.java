...
public class SettingsOfFSBacktest {
    ...
    public static Double indexBelongThatTimePriceEnhanceArgLowBuy = 1.5;   // 对大盘当时涨跌幅, 计入仓位算法时的倍率. 越大则大盘当时涨跌幅影响越大
    public static Double indexBelongThatTimePriceEnhanceArgHighSell = 1.5;   // 对大盘当时涨跌幅, 计入仓位算法时的倍率. 越大则大盘当时涨跌幅影响越大
